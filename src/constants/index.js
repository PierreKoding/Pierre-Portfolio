...
export const PROJECTS = [
  ...
  },
  {
    title: "Floodster",
    image: project3,
    link: "https://github.com/sheraldo-ux/WebProg-Blade",
    description:
      "A web-based flood mapping application that visualizes flood data and risk levels using Mapbox GL JS. It features real-time geolocation, interactive markers with white outlines for improved visibility, and a popup system that provides immediate feedback on flood risk based on user location.",
    technologies: ["Laravel", "JS", "HTML", "Tailwind CSS", "Mapbox GL JS"],
  },
  {
